...
function NotesApp() {
    ...
    return (
        <>
        <div>
            <h3 className="p-6 max-w-2xl mx-auto">Notes App</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {notes.map((note, index) => (
                    <p className="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg shadow-sm border border-gray-100 dark:border-gray-700 min-h-[100px] wrap-break-word" key={index}>{note}</p>
                ))}
            </div>
        </div>
        </>
