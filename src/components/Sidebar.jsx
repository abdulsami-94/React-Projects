  ...
  flex flex-col`}>
                <div className="p-4 flex-1 overflow-y-auto">
                    ...
                    <ul className="space-y-2">
                        <li>
                            <Link to="/" onClick={() => setIsOpen(false)} className="block p-2 rounded-md hover:bg-gray-100 dark:hover:bg-gray-800">Home</Link>
                        </li>
                        <li>
                            <Link to="/project/counter" onClick={() => setIsOpen(false)} className="block p-2 rounded-md hover:bg-gray-100 dark:hover:bg-gray-800">Counter App</Link>
                        </li>
                        <li>
                            <Link to="/project/Movie" onClick={() => setIsOpen(false)} className="block p-2 rounded-md hover:bg-gray-100 dark:hover:bg-gray-800">Movie Search</Link>
                        </li>
                        <li>
                            <Link to="/project/Notes" onClick={() => setIsOpen(false)} className="block p-2 rounded-md hover:bg-gray-100 dark:hover:bg-gray-800">Notes App</Link>
                        </li>
                    </ul>
                </div>
